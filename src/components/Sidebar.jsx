...
const Sidebar = ({ onToggle }) => {
    ...
    const MobileMenuButton = () => (
        <button
            ...
            className="fixed top-4 left-4 z-50 p-2 bg-[#6667ba] rounded-full text-white md:hidden"
        >
            {isOpen ? <MdClose size={24} /> : <AiOutlineMenu size={24} />} {/* Use AiOutlineMenu for hamburger icon */}
        </button>
    );
