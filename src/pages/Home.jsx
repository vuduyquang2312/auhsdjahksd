      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center space-y-6 px-4 text-gray-100">
        <div className="flex flex-col space-y-4 justify-center items-center w-full max-w-2xl">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <p className="text-justify text-gray-800 text-sm md:text-base leading-relaxed px-6 md:px-8 py-6 bg-white rounded-lg ">
          ...
          {showButton && (
            ...
            >
              <Link to="/dat-xe" className="w-full">
                <button className="flex items-center justify-center text-sm md:text-base px-6 py-4 bg-blue-600 text-gray-100 rounded-lg hover:bg-blue-700 hover:scale-105 transform transition duration-300 w-full shadow-lg">
